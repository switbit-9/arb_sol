...
pub trait PositionExtension {
    fn get_bin_array_indexes_bound(&self) -> anyhow::Result<(i32, i32)>;
    fn get_bin_array_keys_coverage(&self) -> anyhow::Result<Vec<Pubkey>>;
    fn get_bin_array_accounts_meta_coverage(&self) -> anyhow::Result<Vec<AccountMeta>>;
