...
pub trait LbPairExtension {
    ...
    fn status(&self) -> anyhow::Result<PairStatus>;
    fn pair_type(&self) -> anyhow::Result<PairType>;
    fn activation_type(&self) -> anyhow::Result<ActivationType>;
    fn compute_fee(&self, amount: u64) -> anyhow::Result<u64>;
    fn get_total_fee(&self) -> anyhow::Result<u128>;
    fn get_base_fee(&self) -> anyhow::Result<u128>;
    fn get_variable_fee(&self) -> anyhow::Result<u128>;
    fn get_token_programs(&self) -> anyhow::Result<[Pubkey; 2]>;
    fn compute_variable_fee(&self, volatility_accumulator: u32) -> anyhow::Result<u128>;
    fn compute_protocol_fee(&self, fee_amount: u64) -> anyhow::Result<u64>;
    fn compute_fee_from_amount(&self, amount_with_fees: u64) -> anyhow::Result<u64>;
    ...
    fn update_references(&mut self, current_timestamp: i64) -> anyhow::Result<()>;
    fn update_volatility_accumulator(&mut self) -> anyhow::Result<()>;
    fn advance_active_bin(&mut self, swap_for_y: bool) -> anyhow::Result<()>;
}
